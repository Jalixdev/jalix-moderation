...
class AFK extends Command {
    ...
    async run(message, args, data) {
        ...
        if (message.content.includes("@here") || message.content.includes("@everyone") || message.content.includes("<@" + config.role.kurucuid +">") || message.content.includes(config.role.kurucuid)) return
